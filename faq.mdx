...
<AccordionGroup>
  ...
  <Accordion title="What's the pool fee?">
    **0%** on block rewards. We don't take any cut from the BTC the pool finds. Operator revenue comes from Hashpower NFT sales, not from your mining.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What ASICs are supported?">
    Anything that speaks standard stratum. Apollo, most Bitaxe models, S19, S21, Whatsminer, Avalon — all work.
  </Accordion>
