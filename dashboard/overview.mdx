...
Visual comparison: the pool's hashrate vs. the global Bitcoin network. The bar has milestone ticks at **100 PH** and **500 PH** so you can see the pool's scale as it grows.
...
Connecting your wallet adds:

- Personalized leaderboard highlights (your row stands out)
- Your referral panel (with your link + share buttons)
- For NFT holders: your tier + active rental status
- The referral leaderboard wrapper on the Mint page

You don't need to connect a wallet to see anyone else's stats — it's all public.
