...
## Your Sovereign Mining Command Center: 

## The BasedMining Dashboard

The BasedMining dashboard is your personalized command center, offering transparency and control over your mining operations and NFT holdings. Designed for both individual miners and Hashpower NFT holders, it provides a comprehensive, real-time overview without ever requiring you to connect your wallet to view public stats.

### Key Features of Your Dashboard:

•Dual Address Linking: Seamlessly view stats associated with both your Bitcoin (bc1q...) and linked EVM (0x...) addresses, providing a unified view of your mining identity.

•Real-time Hashrate & Performance Metrics: Monitor your current hashrate (e.g., 1910.00 H/s with 1-hour average 391.00 TH/s), best difficulty achieved, total work contributed (6.33 G or 0.314664 PH-days), and your pool share. Track historical performance with 6-hour, 1-day, and 7-day average hashrates.

•Worker Management: A detailed table lists all your active workers (e.g., spark3), their individual hashrates, best difficulty, and last submitted share time, allowing you to quickly identify and troubleshoot any performance issues.

•Pool Connection Details: Easily access your stratum endpoint (pool.basedmining.xyz:3333) and stratum username (your Bitcoin address) with convenient copy buttons for quick configuration of your mining hardware.

•Block Discovery Tracking: See the total number of blocks found by the pool during its lifetime, providing a clear indicator of collective success.

•Personalized Leaderboard Highlights: Track your standing and achievements within the BasedMining community.

•Referral Panel: Access your unique referral link and share buttons to invite others to the Sovereign Mining Renaissance.

•NFT Holder Status: For Hashpower NFT holders, the dashboard clearly displays your active tier and rental status, confirming your participation in Block Parties.

•Public Transparency: You don't need to connect a wallet to view any of these statistics for any address—it's all publicly verifiable, reinforcing the trustless nature of BasedMining.

This dashboard is built to empower you with all the information needed to manage your sovereign mining journey, whether you're running physical hardware or participating through Hashpower NFTs.
